...
- [ ] 프론트엔드 API 연동
  ...
  - 진행 상태: mock type/data를 백엔드 API 계약에 맞게 1차 정렬하고, `NEXT_PUBLIC_API_BASE_URL` 기반 공통 API client를 추가함. 로그인, 현재 사용자 조회, 로그아웃 API 1차 연동 및 TypeScript/Next build 확인 완료. 시민 예약 신청/내 예약/취소 API 연동 및 TypeScript/Next build 확인 완료. 직원 대기열/권한 화면 연동과 브라우저 확인은 후속
