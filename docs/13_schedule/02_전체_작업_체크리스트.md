...
- [ ] 샘플 코드 정리 1차
  ...
  - 진행 상태: 레거시 로그인/SNS/관리자 샘플은 삭제하지 않고 Swagger/공개 인증 경로에서 비노출 처리
  - 참고 문서: `docs/10_backend_transition/03_샘플_코드_정리_범위_및_안전_절차.md`, `docs/11_implementation_log/16_eGovFrame_레거시_인증_샘플_비노출_기록.md`
