...
- [ ] Queue Context 구현
  ...
  - 진행 상태: `GET /api/queues`, `POST /api/queues/{id}/call`, `POST /api/queues/{id}/start`, `POST /api/queues/{id}/complete`, `POST /api/queues/{id}/hold`, `POST /api/queues/{id}/no-show`, `POST /api/queues/{id}/cancel` 구현 및 정적 확인 진행. 대기번호 발급 동시성 보강은 후속
  - 참고 문서: `docs/02_domain/02_업무_흐름도.md`
